...
public class MessageBusSubscriber : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Received += async (sender, ea) =>
        {
            ...
            // Obtain scoped instance of IEventProcessor using the factory
            var eventProcessor = _eventProcessorFactory.CreateEventProcessor();
            eventProcessor.ProcessEvent(notificationMessage);

            await Task.Yield(); // Ensure asynchronous processing
        };
